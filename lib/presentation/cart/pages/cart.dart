...
import 'package:ecommerce/presentation/cart/widget/product_orderer_card.dart';
...
class CartPage extends StatelessWidget {
  ...
  Widget _products(List<ProductOrdererEntity> products) {
    return ListView.separated(
        padding: const EdgeInsets.all(16),
        itemBuilder: (context, index) {
          return ProductOrdererCard(
